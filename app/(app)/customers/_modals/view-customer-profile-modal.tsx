...
export function ViewCustomerProfileModal() {
  ...
  if (isLoading) {
    return (
      <Dialog
        ...
        <DialogContent className="sm:max-w-180 flex items-center justify-center min-h-105">
  ...
  return (
    <Dialog
      ...
      <DialogContent
        key={customer.id}
        className="sm:max-w-180 max-h-[90vh] overflow-y-auto p-0">
        {/* Sticky header */}
            ...
            <div className="flex items-start gap-4">
              <Avatar className="h-16 w-16">
                ...
                <AvatarFallback className="text-lg">
                  {/* {getCustomerInitials?.(customer.name) || "CU"} */}
                  {customer.name}
                </AvatarFallback>
              </Avatar>
              ...
              <div className="space-y-2">
                {customer.recent_orders.map((order) => (
                  <div
                    ...
                    role="button"
                    tabIndex={0}
                    className="group flex items-center justify-between gap-4 p-3 border rounded-xl hover:bg-muted/40 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
